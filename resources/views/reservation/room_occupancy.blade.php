...
<table class="ui celled selectable left aligned table compact" style="width:100%" id="roomOccupancy">
    <thead>
        <tr>
            ...
            <th scope="col">Reserved Room Count</th>
            <th scope="col" data-orderable="false">Arrival</th>
            <th scope="col" data-orderable="false">Departure</th>
            <th scope="col">Booking Statistic</th>
        </tr>
    </thead>
<tbody>
</tbody>
...
$(document).ready(function(){
  var table = $('#roomOccupancy').DataTable({
        ...
        columns: [
            { data: 'date', name: 'date' },            
            { data: 'room_count', name: 'room_count' },            
