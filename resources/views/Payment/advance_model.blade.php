<!-- ======================start plan selection model======================= -->
      <div class="modal fade" id="advancePack" tabindex="-1" role="dialog" aria-labelledby="advancePack" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="advancePack">Advance Pack</h5>
            ...
            <!-- input start -->
              <div class="form-group">
                <select required name="payment_duration" id="advance_payment_duration" class="form-control">
              ...
              @if(Auth::user()->shop->payment_plan != 'demo')
                <input type="hidden" value="{{ Auth::user()->shop->monthly_rate }}" id="advance_monthly_starter" name="monthly_rate">
              @else
              @Inject('rates', 'App\Http\Controllers\RateController')
                <input type="hidden" value="{{ $rates->GetSystemRates('advance') }}" id="advance_monthly_starter" name="monthly_rate">
              @endif
              <input type="hidden" value="advance" name="payment_plan">
              <input type="hidden" id="advance_duration" name="payment_duration">
              <input type="hidden" id="advance_total_amount" name="paid_amount">
            ...
            <hr>
            <p id="advance_save_price">Your Total Price Rs.<span id="advance_total_price"></span>,<br>save Rs.<span id="advance_save"></span></p>
            <p id="advance_discount"></p>
            </div>
