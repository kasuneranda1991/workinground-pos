...
<head>
    ...
    <script src="printer/webprint.js"></script>
    <script>
        ...
        getEscSample = function(cut, image){
            var name = 'Name:15151';
            var address = 'Address:5151';
            var contact = 'NIC:5151';
            var description = 'Dsc: 5151';
            var remark = '5151';
            ...
            // cut the ticket
            data+= esc_init + esc_a_c + esc_double + 'Job Receive Note' + "\n" + font_reset;
            data+=esc_a_l + name + "\n";
            data+=address + "\n";
            data+=contact + "\n";
            data+=description + "\n";
...
<body class="container" onload="JavaScript:document.body.focus();" onkeydown="return showKeyCode(event)">
<div>
        ...
        <!-- <button onclick="webprint.printRaw(esc_init+esc_p+esc_init, $('#printerlist').val());">Cash Draw</button><br/> --><br/>
        <input id="cutter" hidden="true" type="checkbox" checked="checked"/><br/>
        <input id="image" hidden="true" type="checkbox" checked="checked"/>
    </p>
<h1>there is an error of if reloadthis page then submit this page data save again and again</h1>
...
<tbody>
    <tr>
        <td colspan="2">
           <div class="btn-group btn-group-sm" role="group" aria-label="Small button group">
                ...
                <a class="btn btn-outline-info" href="/getjob">BACK</a>
            </div> 
        </td>
        <td></td>
    </tr>
    ...
    <tr>
        ...
        <button type="button" class="btn btn-outline-success" onclick="webprint.printRaw(getEscSample($('#cutter').is(':checked'),$('#image').is(':checked')), $('#printerlist').val());">Print</button>
        </td>
    </tr>
  </tbody>
</table>
